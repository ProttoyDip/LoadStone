    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CrisisResources", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CounselorProfiles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "CounselorAvailabilitySlots",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CounselorProfileId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CounselorAvailabilitySlots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CounselorAvailabilitySlots_CounselorProfiles_CounselorProfileId",
                        column: x => x.CounselorProfileId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForumInteractions = table.Column<int>(type: "int", nullable: false),
                    CourseInteractions = table.Column<int>(type: "int", nullable: false),
                    DaysSinceLastAccess = table.Column<int>(type: "int", nullable: false),
                    AssignmentsLateCount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivityLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActivityLogs_StudentProfiles_StudentProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoodJournalEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MoodJournalEntries_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Nudges_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RiskScores_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CounselorBookings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CounselorBookings_CounselorAvailabilitySlots_AvailabilitySlotId",
                        column: x => x.AvailabilitySlotId,
                        principalTable: "CounselorAvailabilitySlots",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CounselorBookings_CounselorProfiles_CounselorProfileId",
                        column: x => x.CounselorProfileId,
                        principalTable: "CounselorProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CounselorBookings_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RiskQueueEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RiskQueueEntries_RiskScores_RiskScoreId",
                        column: x => x.RiskScoreId,
                        principalTable: "RiskScores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RiskQueueEntries_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "CounselorSessionReports",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CounselorBookingId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CounselorSessionReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CounselorSessionReports_CounselorBookings_CounselorBookingId",
                        column: x => x.CounselorBookingId,
                        principalTable: "CounselorBookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CounselorBookings_AvailabilitySlotId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CounselorSessionReports_CounselorBookingId",
                table: "CounselorSessionReports",
                column: "CounselorBookingId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForumFlags_ForumPostId",
                table: "ForumFlags",
                column: "ForumPostId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RiskQueueEntries_RiskScoreId",
